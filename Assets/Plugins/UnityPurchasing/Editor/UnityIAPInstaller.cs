...
// the editor crashes when the method is called with DidReloadScripts.
        ...
        internal static readonly Artifact[] k_Artifacts =
        {
            ...
            new Artifact("Resources/one.unitypackage", null, false, "UDP"),
            new Artifact("Resources/two.unitypackage", () => ShouldInstallTestTwo(), false, "Unity IAP"),
#else
            ...
            new Artifact("Plugins/UnityPurchasing/UDP.unitypackage", null, false, "Unity Distribution Platform (required)"),
            new Artifact("Plugins/UnityPurchasing/UnityIAP.unitypackage", () => ShouldInstallUnityIAP(), true, "Unity IAP"),
#endif
        };
...
#if DEBUG_USE_TEST_ASSETS
        private static bool ShouldInstallTestTwo()
        {
            return DoesMethodExist("PackageOne", "IsInvoking");
        }
#endif

        private static bool ShouldInstallUnityIAP()
        {
            // Check for existence of UnityEngine.UDP.StoreService.Initialize
            return DoesMethodExist("UnityEngine.UDP", "StoreService", "Initialize");
        }
    ...
    public class ManualInstallerWindow : EditorWindow
    {
        ...
        void OnGUI()
        {
            ...
            EditorGUILayout.LabelField(
                ...
                "\n" +
                "Unity IAP requires the Unity Distribution Platform (UDP) package to be imported first. \n" +
                "\n" +
                "Please accept the \"API Upgrade\" dialog to complete importation, when it appears.",
                subHeaderStyle);
